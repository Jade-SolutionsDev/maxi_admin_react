...
test.describe('Los formularios de la administración', () => {
  ...
  test('Tampoco se cierra el formulario de invitar a alguien', async ({ When, Then, And, page }) => { 
    await When('abre el formulario de invitar usuario', null, { page }); 
    await And('pulsa fuera del formulario', null, { page }); 
    await Then('el formulario de invitación sigue abierto', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":29,"pickleLine":27,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":9,"keywordType":"Context","textWithKeyword":"Dado que hay productos de prueba en el catálogo","isBg":true,"stepMatchArguments":[]},{"pwStepLine":30,"gherkinStepLine":28,"keywordType":"Action","textWithKeyword":"Cuando abre el formulario de invitar usuario","stepMatchArguments":[]},{"pwStepLine":31,"gherkinStepLine":29,"keywordType":"Action","textWithKeyword":"Y pulsa fuera del formulario","stepMatchArguments":[]},{"pwStepLine":32,"gherkinStepLine":30,"keywordType":"Outcome","textWithKeyword":"Entonces el formulario de invitación sigue abierto","stepMatchArguments":[]}]},
]; // bdd-data-end