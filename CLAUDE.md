...
Guía para Claude Code en el back-office (React 19 + Vite + ra-core + shadcn-admin-kit).
Lee `AGENTS.md` en este directorio y el `CLAUDE.md` de la raíz del workspace primero.
